...
TOKENIZER_URL = os.environ.get("TOKENIZE_URL")
TOKENIZER_MODEL_NAME = os.environ.get("TOKENIZE_MODEL_NAME")
MAX_EMBEDDING_TOKENS = os.environ.get("MAX_EMBEDDING_TOKENS", 32768)
